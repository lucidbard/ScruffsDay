"""
Animate scruff-flying.png into a looping spritesheet using ComfyUI Wan 2.2 FLF2V.
"""
...
SOURCE_PNG = PROJECT_ROOT / "public" / "assets" / "characters" / "scruff-flying.png"
OUTPUT_SHEET = PROJECT_ROOT / "public" / "assets" / "characters" / "scruff-fly-sheet.png"
WORK_DIR = PROJECT_ROOT / "tools" / "_scruff_fly_work"
FRAMES_PER_PASS = 25
SEED = 77
...
PROMPT = "cartoon bird flying, gentle wing flapping cycle, smooth looping wing up and down, green screen background"
NEGATIVE = "deformation, morphing, extra limbs, text, watermark, blurry, new objects, body rotation, head turning, mouth opening, background change"
...
async def queue_prompt(session, base_url, workflow):
    ...
    payload = {"prompt": workflow, "client_id": "scruff-fly-animator"}
...
async def main():
    print("=== Scruff Flying Animation Pipeline ===\n")
    ...
    async with aiohttp.ClientSession() as session:
        ...
        frames = await download_output_frames(session, COMFYUI_URL, entry, frames_dir, "scruff_fly")
